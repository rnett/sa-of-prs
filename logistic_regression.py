...
'''
print("Issues:")
print("All    -", to_percent(log_reg('sentiment-issue2.csv', ['sum_pos', 'sum_neg', 'min_neg', 'max_pos', 
'num_comments', 'has_images', 'has_code_snippets'])))
...
print("\nReviews:")
print("All    -", to_percent(log_reg('sentiment-review.csv', ['sum_pos', 'sum_neg', 'min_neg', 'max_pos', 
'num_comments', 'has_images', 'has_code_snippets'])))
...
print("\nBoth:")
print("All    -", to_percent(log_reg('sentiment-both.csv', ['sum_pos', 'sum_neg', 'min_neg', 'max_pos', 
'num_comments', 'has_images', 'has_code_snippets'])))
